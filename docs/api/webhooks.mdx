...
Taktikal sents out webhook events for `Created`, `SignedDocument`, `AllSigned`, `Canceled`
or `Expired`,

| Event name       |  Event description                                                                                 | contains document  | integer value |
| ---------------- | -------------------------------------------------------------------------------------------------- | ------------------ | ------------- |
| `Created` |  This is an event that is triggerd when a new signing process is created.                                 | :red_circle:       |  10           |
