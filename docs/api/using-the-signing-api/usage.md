  ...
  "createSignees": [
    {
      ...
      "phoneNumber": "8433600",
      "communicationDeliveryType": "none", // can be "none, email, sms"
    ...
    "signees": [
        {
            ...
            "url": "https://app-dev.taktikal.is/s/sp288498d30317/sib413a317b8ea"
        }
    ],
    "flowKey": "7e364abfaxx5",
    "status": "Created",
...
- Node.js (Axios)
  ...
  var config = {
    ...
    headers: {
      Accept: 'application/json',
      Authorization:
        'Basic XmM0ZTdkODZjNzI0OmFwaS0wYjU3OTBjY2EzYjQ0YWU4OTBiOTUwOGRjMDgz',
      'Content-Type': 'application/json',
      Cookie:
        'ss-id=md157s6X6h1coQz6JzBH; ss-opt=temp; ss-pid=9CCMLBze8d1p0C4OnpdT',
    },
    data: data,
  };
...
When working with the dev API you can use fake `ssn` to fake a signature. This
is useful for testing and has no added cost.

### Test signatures

| Name | SSN | Phone number | | --------------------------- | ---------- |
------------ | | Undirritari Björn Egilsson | 5000101886 | 1111111 | |
Undirritari Jónsson | 6000101990 | 2222222 | | Sigrún prófari Helgadóttir |
6000101991 | 3333333 | | Dagný prófari Bjarkadóttir | 6000101992 | 4444444 | |
Bogmundur Meistari Fálkason | 6000101993 | 5555555 | | Hásmundur Helgason |
6000101994 | 6666666 | | Björnmundur Þórsson | 6000101995 | 7777777 | | Símalína
Magnúsdóttir | 6000101996 | 8888888 | | Maðkur þór Jónsson | 6000101997 |
9999999 |
